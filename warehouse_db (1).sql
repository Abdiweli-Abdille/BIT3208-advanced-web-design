...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 02:07 PM
...
(1, 'low_stock', 4, 1, 'UPS 1500VA APC: Current stock (8 units) is below reorder level (10 units). Immediate reorder recommended.', 'critical', 0, 0, 0, '2026-03-01 13:03:57', '2026-02-28 14:18:18'),
...
(18, 'overstock', 5, 11, 'ft', 'critical', 0, 0, NULL, NULL, '2026-03-03 12:15:50');
...
INSERT INTO `orders` (`order_id`, `order_number`, `order_type`, `customer_supplier_name`, `customer_supplier_email`, `customer_supplier_phone`, `status`, `total_amount`, `tax_amount`, `notes`, `expected_date`, `completed_date`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 'ORD-IN-001', 'incoming', 'TechHub Kenya Ltd', 'orders@techhub.co.kess', '+254712345678', 'completed', 1625000.00, 234000.00, NULL, '2025-09-06', '2025-09-08 17:18:18', 1, '2025-09-01 14:18:18', '2026-03-03 12:18:05'),
(2, 'ORD-IN-002', 'incoming', 'East Africa Supplies Co.', 'grace@easupplies.comss', '+254722456789', 'completed', 742500.00, 106920.00, NULL, '2025-10-11', '2025-10-13 17:18:18', 1, '2025-10-06 14:18:18', '2026-03-03 12:18:11'),
(3, 'ORD-IN-003', 'incoming', 'Premier Distributors EA', 'peter@premierea.com', '+254755789012', 'completed', 265000.00, 38160.00, NULL, '2025-11-30', '2025-12-02 17:18:18', 1, '2025-11-25 14:18:18', '2026-02-28 14:18:18'),
(4, 'ORD-IN-004', 'incoming', 'Kenya Industrial Supplies', 'ruth@kindsup.co.kess', '+254766890123', 'processing', 380000.00, 54720.00, NULL, '2026-03-05', NULL, 1, '2026-02-25 14:18:18', '2026-03-03 12:18:16'),
(5, 'ORD-IN-005', 'incoming', 'SafeGuard Products Ltd', 'samuel@safeguard.co.ke', '+254777901234', 'pending', 115500.00, 16632.00, NULL, '2026-03-10', NULL, 1, '2026-02-27 14:18:18', '2026-02-28 14:18:18'),
(6, 'ORD-OUT-001', 'outgoing', 'Nairobi County Government', 'procurement@nairobi.go.ke', '+254720111222', 'completed', 2380000.00, 342720.00, NULL, '2025-09-26', '2025-09-28 17:18:18', 2, '2025-09-21 14:18:18', '2026-02-28 14:18:18'),
(7, 'ORD-OUT-002', 'outgoing', 'Kenya Power Ltd', 'orders@kplc.co.ke', '+254730222333', 'completed', 965000.00, 138960.00, NULL, '2025-10-21', '2025-10-23 17:18:18', 2, '2025-10-16 14:18:18', '2026-02-28 14:18:18'),
(8, 'ORD-OUT-003', 'outgoing', 'Safaricom PLC', 'procurement@safaricom.co.ke', '+254740333444', 'completed', 1250000.00, 180000.00, NULL, '2025-11-15', '2025-11-18 17:18:18', 2, '2025-11-10 14:18:18', '2026-02-28 14:18:18'),
(9, 'ORD-OUT-004', 'outgoing', 'University of Nairobi', 'supply@uon.ac.ke', '+254750444555', 'completed', 435000.00, 62640.00, NULL, '2025-12-15', '2025-12-17 17:18:18', 2, '2025-12-10 14:18:18', '2026-02-28 14:18:18'),
(10, 'ORD-OUT-005', 'outgoing', 'Equity Bank Kenya', 'procurement@equity.co.keff', '+254760555666', 'processing', 890000.00, 128160.00, NULL, '2026-03-03', NULL, 2, '2026-02-23 14:18:18', '2026-03-03 12:17:30'),
(11, 'ORD-OUT-006', 'outgoing', 'KCB Group Ltd', 'orders@kcb.co.keff', '+254770666777', 'pending', 325000.00, 46800.00, NULL, '2026-03-07', NULL, 2, '2026-02-26 14:18:18', '2026-03-03 12:17:33'),
(12, 'ORD-IN-006', 'incoming', 'Global Trade Partners', 'ahmed@globaltp.comff', '+254733567890', 'delayed', 540000.00, 77760.00, NULL, '2026-02-23', NULL, 1, '2026-02-13 14:18:18', '2026-03-03 12:17:37');
...
(25, 'PRD025', 'Drinking Water 5L Bottle', 8, 8, 180.00, 230.00, 200, 50, 500, 'bottles', '2025-09-30', 'H1', 'I02', NULL, 'active', '2026-02-28 14:18:18', '2026-02-28 14:18:18'),
(26, 'PRD026', 'Engine Oil 5L SAE 20W50', 9, 3, 2800.00, 3500.00, 38, 10, 100, 'units', NULL, 'I1', 'J01', NULL, 'active', '2026-02-28 14:18:18', '2026-02-28 14:18:18'),
...
INSERT INTO `suppliers` (`supplier_id`, `supplier_name`, `contact_person`, `email`, `phone`, `address`, `city`, `country`, `status`, `created_at`) VALUES
(1, 'TechHub Kenya Ltd', 'James Mwangi', 'orders@techhub.co.kety', '+254712345678', 'Industrial Area, Nbi Road', 'Nairobi', 'Kenya', 'active', '2026-02-28 14:18:18'),
(2, 'East Africa Supplies Co.', 'Grace Akinyi', 'grace@easupplies.comse', '+254722456789', 'Mombasa Road, Ind Zone', 'Nairobi', 'Kenya', 'active', '2026-02-28 14:18:18'),
(3, 'Global Trade Partners', 'Ahmed Hassan', 'ahmed@globaltp.comyh', '+254733567890', 'Westlands, Chiromo Rd', 'Nairobi', 'Kenya', 'active', '2026-02-28 14:18:18'),
(4, 'Sunrise Manufacturing', 'Fatuma Omar', 'fatuma@sunrise.co.kety', '+254744678901', 'Athi River Industrial', 'Machakos', 'Kenya', 'active', '2026-02-28 14:18:18'),
(5, 'Premier Distributors EA', 'Peter Kamau', 'peter@premierea.comtyh', '+254755789012', 'Thika Superhighway, KM 15', 'Kiambu', 'Kenya', 'active', '2026-02-28 14:18:18'),
(6, 'Kenya Industrial Supplies', 'Ruth Njeri', 'ruth@kindsup.co.kety', '+254766890123', 'Industrial Area, Enterprise Rd', 'Nairobi', 'Kenya', 'active', '2026-02-28 14:18:18'),
(7, 'SafeGuard Products Ltd', 'Samuel Rotich', 'samuel@safeguard.co.kety', '+254777901234', 'Karen, Ngong Road', 'Nairobi', 'Kenya', 'active', '2026-02-28 14:18:18'),
(8, 'Fresh Imports Ltd', 'Lucy Wambui', 'lucy@freshimports.co.keye', '+254788012345', 'JKIA Freight Terminal', 'Nairobi', 'Kenya', 'active', '2026-02-28 14:18:18');
...
(1, 'System Administrator', 'admin@warehouse.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'active', '2026-03-03 16:05:21', '17d59ae22ceaae6388740929c23d355c63e65fbb4148446561ef7ef848ecb0fb', '2026-02-28 14:18:18', '2026-03-03 13:05:21'),
(2, 'John Kariuki', 'manager@warehouse.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'active', '2026-03-03 16:04:44', 'b0576b3f51beb2fcf9e07327ac3256635d482fe0208d1d43e6b4e3c06fef896d', '2026-02-28 14:18:18', '2026-03-03 13:04:44'),
...
--
ALTER TABLE `stock_movements`
  MODIFY `movement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
